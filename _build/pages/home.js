...
// decorativo): las 4 categorías más buscadas, sin las 4 restantes porque el
// hero solo tiene sitio para 4 tarjetas.
const HERO_LABELS = {
  "camaras-wifi-interior": "Cámara interior",
  "camaras-wifi-exterior": "Cámara exterior",
  "timbres-inteligentes-con-camara": "Timbre con cámara",
  "cerraduras-inteligentes": "Cerradura",
};
  ...
  <section class="hero">
    <div class="wrap hero-inner">
      <div class="hero-copy">
        ...
        <h1>${SITE.claim}</h1>
        <p class="hero-dek">
          Comparamos criterios, no marcas: qué mirar antes de comprar una cámara WiFi, un
          timbre con cámara, una cerradura inteligente o un kit de videovigilancia, explicado
  ...
  <section class="section trust-section">
    <div class="wrap trust-grid">
      <div>
        ...
        <p>
          Elegir seguridad para el hogar implica decidir sobre productos que tocan algo tan
          sensible como la privacidad y el acceso a tu propia casa: una cámara mal elegida, una
          cerradura sin la compatibilidad adecuada o un kit de vigilancia que se queda corto de
          canales se notan justo el día que de verdad los necesitas. ${SITE.name} reúne los
          criterios que importan de cada tipo de producto para que la decisión no dependa de
          adivinar.
        </p>
        <p>
